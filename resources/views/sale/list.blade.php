                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom"
                                                    ...
                                                    <thead class="bg-primary">
                                                        <tr role="row">
                                                            ...
                                                            <th class="text-center text-white">Sale ID</th>
                                                    ...
                                                    <tbody>
                                                        @forelse ($sales as $key => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><img width="150"
                                                                        src="{{ asset('uploads/sale_product/' . $item->product?->image) }}"
                                                                        alt=""> </td>
                                                                <td>{{ $create }} </td>
                                                                    ...
                                                                    <div class="btn-group" role="group"
                                                                        ...
                                                                        <a href="{{ route('admin.sale.edit', $item->id) }}"
                                                                            ...
                                                                            <i class="fa fa-edit" data-bs-toggle="tooltip"
                                                                                title=""
                                                                                data-bs-original-title="Show Sale Details"
                                                                                aria-label="Show Sale Details"></i>
                                                                        </a>
                                                                        ...
                                                                        <a target="_blank"
                                                                            href="{{ route('admin.sale.print', $item->id) }}"
