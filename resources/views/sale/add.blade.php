                    ...
                    <form action="{{ route('admin.sale.store') }}" id="productForm" method="post"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="form-label">Select Product Sale Date</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <span class="feather feather-calendar"></span>
                                                </div>
                                            </div><input class="form-control fc-datepicker1 " name="created_at"
                                        ...
                                        <div class="row productRow">
                                            <div class="col-sm-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <select name="" onchange="getProductValue(this)"
                                                        class="form-controll serchBox sale_product_id" id="product_id" >
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="form-group">
                                                    <label class="form-label">Select Size Category<span
                                                            class="text-red">*</span></label>
                                                    <select name=""
                                                        class="form-controll serchBox category_size_id"  id="">
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="form-group">
                                                    <label class="form-label">Select GSM Category<span
                                                            class="text-red">*</span></label>
                                                    <select name="" class="form-controll serchBox category_gsm_id"
                                                         id="">
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="form-group">
                                                    <label class="form-label">Select Color Category<span
                                                            class="text-red">*</span></label>
                                                    <select name=""
                                                        class="form-controll serchBox category_color_id"  id="">
                                            ...
                                            <div class="col-sm-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step=any  readonly class="form-control price" id=''
                                                        name="" placeholder="Enter Product Price" >
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                        ...
                        <div class="card disabledBox">
                            <div class=" card-body row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="form-group">
                                        <div class="form-label">SMS Send Switch</div>
                                        <label class="custom-switch">
                                            <input type="checkbox" checked name="sms_send" class="custom-switch-input">
    ...
    <script>
       ...
       function calculateTotalAmount(){
        ...
        function removeItem(id) {
            ...
            $.ajax({
                type: 'Post',
                url: "{{ route('admin.saleRemoveItem') }}",
                data: {
                    item_id: id,
                    _token: "{{ csrf_token() }}",
                },
