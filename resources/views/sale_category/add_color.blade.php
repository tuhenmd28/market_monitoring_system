        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title"> Color Category</div>
                </div>
            ...
            <div class="row flex-lg-nowrap">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <form
                            action="{{ isset($singlecolor) ? route('admin.category_color.update', $singlecolor->id) : route('admin.category_color.store') }}"
                            method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="card-header border-bottom-0">
                                <h3 class="card-title"> {{ isset($singlecolor) ? 'Edit' : 'Add' }} Color Category </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ isset($singlecolor) ? $singlecolor->name : '' }}"
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="" class="form-control select2">
                                                    <option {{ $singlecolor->status == 1 ? 'selected' : '' }} value="1">Show
                                                    </option>
                                                    <option {{ $singlecolor->status == 0 ? 'selected' : '' }} value="0">Hide
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header border-bottom-0">
                            <h3 class="card-title"> Color Category List </h3>
                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{ route('admin.category_color.edit', $item->id) }}"
                                                                    ...
                                                                    <button type="button" class="btn btn-danger btn-sm"
                                                                        onclick="deleteItem('{{ $item->id }}','CategoryColor')">
