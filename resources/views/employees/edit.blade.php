        ...
        <div class="side-app main-container">
            ...
            <div class="row flex-lg-nowrap">
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('admin.employe.update',$employe->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Enter Employe Name" required value="{{ $employe->name }}">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                placeholder="Enter Party Phone Number" value="{{ $employe->phone }}" required>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Enter Party Email" value="{{ $employe->email }}" >
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="salary"
                                                placeholder="Enter Employe salary" required value="{{ $employe->salary }}">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="due_salary"
                                                placeholder="Enter Due salary" required value="{{ $employe->due_salary }}">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="addvance_salary"
                                                placeholder="Enter Addvance salary" required value="{{ $employe->addvance_salary }}">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class=" form-group">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                </div><input class="form-control " name="joining_date" value="{{ $employe->joining_date }}" id="selectDate" placeholder="MM/DD/YYYY" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class=" form-group">
                                            ...
                                            @foreach ($status as $k=>$st)
                                                <option @selected($k == $employe->status) value="{{ $k }}">
                                                    {{ $st }}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control content m-0" name="address" placeholder="Enter Party Address" required>{{ $employe->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-label">Employe Profile Picture  (Optional)</label>
                                            <input type="file" name="image" data-default-file="{{ asset('uploads/employe')."/".$employe->image }}" class="dropify" data-height="150">
                                        </div>
                                    </div>
