        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title">Edit Employee Salary</div>
                </div>
                                                            ...
                                                            {{-- @forelse ($salary as $key => $salary) --}}
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <input type="checkbox"
                                                                            {{-- onchange="removeRequired(this,1)" --}}
                                                                            value="{{ $salary->employee_id }}" checked name="employe_id[]"
                                                                            class="employe_id">
                                                                    </td>
                                                                    <td>{{ $salary->employe->name }}</td>
                                                                    <td>{{ $salary->salary }} <input required type="hidden" value="{{ $salary->salary }}" name="salary[]"> </td>
                                                                    <td class="daily_salary1">
                                                                        <input type="number" required readonly class="form-control"
                                                                            any value="{{ $salary->daily_salary }}"
                                                                            name="daily_salary[]">
                                                                    </td>
                                                                    <td class="work_days1">
                                                                        <input type="number" required
                                                                            onkeyup="workDays(this,1)"
                                                                            class="form-control" value="{{ $salary->work_days }}"
                                                                            name="work_days[]">
                                                                    </td>
                                                                    <td class="basic_salary1">
                                                                        <input type="number" class="form-control" readonly
                                                                            value="{{ $salary->base_salary }}" required name="base_salary[]">
                                                                    </td>
                                                                    <td class="overtime_hour1">
                                                                        <input type="number"
                                                                            onkeyup="overTimeHour(this,1)"
                                                                            class="form-control" value="{{ $salary->overtime_hour }}" required
                                                                            name="overtime_hour[]">
                                                                    </td>
                                                                    <td class="per_hour1">
                                                                        <input type="number"
                                                                            onkeyup="PerHour(this,1)"
                                                                            class="form-control" value="{{ $salary->per_hour }}" required
                                                                            name="per_hour[]">
                                                                    </td>
                                                                    <td class="overtime_salary1">
                                                                        <input type="number" class="form-control" readonly
                                                                            value="{{ $salary->overtime_salary }}" required name="overtime_salary[]">
                                                                    </td>
                                                                    <td class="bonuse1">
                                                                        <input type="number"
                                                                            onkeyup="bonuse1(this,1)"
                                                                            class="form-control" value="{{ $salary->bonuse }}"
                                                                            name="bonuse[]" required>
                                                                    </td>
                                                                    <td class="due1">
                                                                        <input type="number" readonly class="form-control"
                                                                            value="{{ $salary->due }}" name="due[]">
                                                                        @if ($salary->due > 0)
                                                                            <span class="d-block"> <input type="checkbox"
                                                                                    class="due_status" @checked($salary->due_status)
                                                                                    onclick="due_status(this,1)">
                                                                                <input type="hidden" class="status_value" name="due_status[]"
                                                                                    value="{{ $salary->due_status }}">
                                                                            </span>
                                                                            @else
                                                                            <span class="d-block">
                                                                    ...
                                                                    <td class="advance1">
                                                                        ...
                                                                        @if ($salary->advance > 0)
                                                                            <span class="d-block"> <input type="checkbox"
                                                                                    class="advance_status" @checked($salary->advance_status)
                                                                                    onclick="advance_status(this,1)">
                                                                                <input type="hidden" class="status_value"
                                                                                    name="advance_status[]"
                                                                                    value="{{ $salary->advance_status }}">
                                                                            </span>
                                                                        @else
                                                                        <span class="d-block">
                                                                        <input type="hidden" class="status_value"
                                                                    ...
                                                                    <td class="total1">
                                                                        <input type="number" class="form-control"
                                                                            readonly value="{{ $salary->total }}" required name="total[]">
                                                                    </td>
                                                                    <td class="paid1">
                                                                        <input type="number" onkeyup="paid1(this,1)" class="form-control"
                                                                            value="{{ $salary->paid }}" required  name="paid[]">
                                                                    </td>
                                                                    <td class="due_salary1">
                                                                        <input type="number" class="form-control" required readonly
                                                                            value="{{ $salary->due_salary }}" name="due_salary[]">
                                                                    </td>
