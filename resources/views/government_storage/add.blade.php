...
@section('title', 'Add Government Storage')
        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title">Add New Government Storage</div>
                </div>
            ...
            <div class="row flex-lg-nowrap">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="card">
                        <form action="{{ route('admin.government_storage.store') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="card-header border-bottom-0">
                                <h3 class="card-title">Add Government Storage </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
