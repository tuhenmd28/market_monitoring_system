                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom" style="width:100%"
                                                    ...
                                                    <thead class="bg-primary " >
                                                        <tr role="row ">
                                                            ...
                                                            <th class="text-center text-white">Upazila</th>
                                                            <th class="text-center text-white">Union</th>
                                                    ...
                                                    <tbody>
                                                        @forelse ($governmentStorage as $key => $item)
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                                            ...
                                                                            <a href="{{ route('admin.government_storage.edit', $item->id) }}"
                                                                                class="btn btn-warning btn-sm"
                                                                                >
                                                                                <i class="fa fa-edit" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit" aria-label="Edit"></i>
                                                                            </a>

                                                                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteItem('{{ $item->id }}','government_storage')" >
