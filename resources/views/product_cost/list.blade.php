...
@section('title', ' Product Cost List')
        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title"> Product Cost List</div>
                </div>
                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom" style="width:100%"
                                                    ...
                                                    <thead class="bg-primary " >
                                                        <tr role="row ">
                                                            ...
                                                            <th class="text-center text-white">Resone</th>
                                                    ...
                                                    <tbody>
                                                        @forelse ($product_cost as $key => $item)
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><img width="150" src="{{ asset('product/'.$item->product?->image) }}" alt=""> </td>
                                                                <td>{{ $item->cost  }} </td>
                                                                <td>{{ $create }} </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                                            ...
                                                                            <a href="{{ route('admin.product_cost.edit', $item->id) }}"
                                                                                class="btn btn-warning btn-sm"
                                                                                >
                                                                                <i class="fa fa-edit" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit" aria-label="Edit"></i>
                                                                            </a>

                                                                            <button type="button" class="btn btn-danger btn-sm" onclick="deleteItem('{{ $item->id }}','product_cost')" >
