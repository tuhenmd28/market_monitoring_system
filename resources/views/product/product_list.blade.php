...
@section('content')
    ...
    <div class="app-content main-content">
        <div class="side-app main-container">
            ...
            <form action="{{ route('admin.search_product') }}" method="post">
                @csrf
                <!-- Row -->
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-md-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    </div><input class="form-control rangeDatepicker flatpickr-input" name="from" placeholder="MM/DD/YYYY" type="text" id="from" readonly="readonly">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered text-nowrap border-bottom" style="width:100%"
                                                        ...
                                                        <thead class="bg-primary">
                                                            <tr role="row">
                                                                <th class="text-center text-white">ALL</th>
                                                        ...
                                                        <tbody>
                                                            @forelse ($products as $key => $item)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><img width="150"
                                                                            src="{{ asset('uploads/sale_product/' . $item->image) }}"
                                                                            alt=""> </td>
                                                                    <td>{{ $create }} </td>
                                                                    <td>{!! $item->status == 1
                                                                        ? '<span class="badge badge-success-light">Show</span>'
                                                                        : '<span class="badge badge-danger-light">Hide</span>' !!} </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="btn-group" role="group"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                onclick="deleteItem('{{ $item->id }}','SaleProduct')">
