        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title">User Role</div>
                </div>
            ...
            <div class="row flex-lg-nowrap">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="card">
                        <form action="{{  !isset($editRole)?route('admin.role.store'):route('admin.role.update',$editRole->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @isset($editRole)
                                @method("put")
                            @endisset
                            ...
                            <div class="card-header border-bottom-0">
                                <h3 class="card-title">{{!isset($editRole)?"Add":"Edit" }} Role </h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ isset($editRole)?$editRole->name:'' }}" class="form-control" name="name"
                                ...
                                <table class="display  table-responsive" style="width:100%" id="package">
                                    ...
                                    <tbody>
                                        @forelse ($roles as $key => $role)
                                            @php
                                                $create = \Carbon\Carbon::parse($role->created_at)->format('d-m-Y');
                                                        ...
                                                        aria-label="Basic mixed styles example">
                                                            ...
                                                            <a href="{{ route('admin.rolePermission', $role->id) }}"
                                                                ...
                                                                <i class="fa fa-user" data-bs-toggle="tooltip"
                                                                    title="" data-bs-original-title="Assign Permission"
                                                                    aria-label="Assign Permission"></i>
                                                                    {{-- <i class="pe-7s-user"></i> --}}
                                                            </a>

                                                            <button type="button" class="btn btn-danger btn-sm"
                                                                onclick="deleteItem('{{ $role->id }}','role')">
