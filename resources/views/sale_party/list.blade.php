        ...
        <div class="side-app main-container">
            ...
            <div class="page-header d-lg-flex d-block">
                <div class="page-leftheader">
                    <div class="page-title">Sale Party List</div>
                </div>
                                                    ...
                                                    <tbody>
                                                        @forelse ($party as $key => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->due }}</td>
                                                                <td>{{ $item->advence }}</td>
                                                                <td><img width="150" src="{{ asset('uploads/party/'.$item->logo) }}" alt="logo"> </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                                        <a href="{{ route('admin.party.edit', $item->id) }}"
                                                                            class="btn btn-warning btn-sm"
                                                                            >
                                                                            <i class="fa fa-edit" data-bs-toggle="tooltip" title="" data-bs-original-title="Edit" aria-label="Edit"></i>
                                                                        </a>
                                                                        <a href="{{ route('admin.party.show', $item->id) }}"
                                                                            class="btn btn-success btn-sm"
                                                                            >
                                                                            <i class="fa fa-eye" data-bs-toggle="tooltip" title="" data-bs-original-title="View Sale Party" aria-label="View Package"></i>
                                                                        </a>
                                                                        <button type="button" class="btn btn-danger btn-sm" onclick="deleteItem('{{ $item->id }}','SParty')" >
