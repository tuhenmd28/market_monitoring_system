    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-lg-flex d-block">
            <div class="page-leftheader">
                <div class="page-title"> Sale Party Details </div>
            </div>
                        ...
                        <div class="main-profile-contact-list row justify-content-end">
                            <div class="media col-sm-4 p-0">
                                <div class="media-body text-center">
                                    <span class="text-bold h5">Party Advance</span>
                                    <div class="h5 text-secondary">
                                       {{ numberFormate($Party->advence) }}
                                    </div>
                                </div>
                            </div>
                            <div class="media col-sm-4 p-0">
                                ...
                                <div class="media-body text-center">
                                    <span class="text-bold h5">Party Due</span>
                                    <div class="h5 text-danger">
                                        {{ numberFormate($Party->due) }}
                                    </div>
                                </div>
                            </div>
                            @isset($orderPrice)
                    ...
                    <div class="tab-menu-heading p-0">
                        <div class="tabs-menu1 px-3">
                            <ul class="nav">
                                ...
                                <li><a href="#tab-9" data-bs-toggle="tab" class="">Advance List</a></li>
                                <li><a href="#tab-10" data-bs-toggle="tab" class="">Advance Collection</a></li>
                                <li><a href="#tab-11" data-bs-toggle="tab" class="">Due Collection</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table mt-3 table-responsive text-white table-bordered calculateTable">
                                                <tr>
                                                    <th>Total Price</th>
                                                    <th>{{ numberFormate($sales->sum('total_amount')) }}</th>
                                                    <th>Total Paid</th>
                                                    <th>{{ numberFormate($sales->sum('pay_amount')) }}</th>
                                                    <th>Total Due</th>
                                                    <th>{{ numberFormate($sales->sum('due_amount')) }}</th>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane" id="tab-8">
                            <div class="">
                                <div class="">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Party Due List</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table  width="100%" class="partyList display table-striped table-responsive text-center">
                                                    <thead class="bg-primary">
                                                        <tr role="row">
                                                            ...
                                                            <th class="text-center text-white">Order Id</th>
                                                            <th class="text-center text-white">Due</th>
                                                            <th class="text-center text-white">Create Date</th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            <table class="table mt-3 table-responsive text-white table-bordered calculateTable">
                                                <tr>
                                                    ...
                                                    <th>{{ numberFormate($dueList->sum('due')) }}</th>
                        ...
                        <div class="tab-pane" id="tab-9">
                            <div class="">
                                <div class="">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Party Advance List</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table  width="100%" class="partyList display table-striped table-responsive text-center">
                                                    <thead class="bg-primary">
                                                        <tr role="row">
                                                            ...
                                                            <th class="text-center text-white">Name</th>
                                                            <th class="text-center text-white">Order Id</th>
                                                            <th class="text-center text-white">Adjust Advance</th>
                                                            <th class="text-center text-white">Create Date</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                            ...
                                            <table class="table mt-3 table-responsive text-white table-bordered calculateTable">
                                                <tr>
                                                    <th>Total Adjust Advance</th>
                                                    <th>{{ numberFormate($advanceList->sum('due')) }}</th>
                        ...
                        <div class="tab-pane" id="tab-10">
                            <div class="">
                                <div class="">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Party Advance Collection List</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                ...
                                                <table  width="100%" class="partyList display table-striped table-responsive text-center">
                                                    ...
                                                    <tbody>
                                                        @forelse ($advanceCollection as $key => $item)
                                                            @php
                                                                $create = \Carbon\Carbon::parse($item->created_at)->format('d-m-Y');
                                            ...
                                            <table class="table mt-3 table-responsive text-white table-bordered calculateTable">
                                                <tr>
                                                    ...
                                                    <th>{{ numberFormate($advanceCollection->sum('amount')) }}</th>
                        ...
                        <div class="tab-pane" id="tab-11">
                            <div class="">
                                <div class="">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Party Due Collection List</h3>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table  width="100%" class="partyList display table-striped table-responsive text-center">
                                                    ...
                                                    <tbody>
                                                        @forelse ($dueCollection as $key => $item)
                                                            @php
                                                                $create = \Carbon\Carbon::parse($item->created_at)->format('d-m-Y');
                                            ...
                                            <table class="table mt-3 table-responsive text-white table-bordered calculateTable">
                                                <tr>
                                                    ...
                                                    <th>{{ numberFormate($dueCollection->sum('amount')) }}</th>
