...
<body>
    ...
    <div class="User-reg">
        <div class="container">
            ...
            @endif
            <form action="{{ route('farmer_signup_store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="phone">Total Land ( katha )</label>
                        <input type="number" any id="phone" name="total_land" value="{{ old('total_land') }}"
                            placeholder="Enter your Total Land" required>

                    </div>
                    <div class="col-md-6">
                        <label for="phone">Own Land ( katha )</label>
                        <input type="number" any id="phone" name="own_land" value="{{ old('own_land') }}"
                            placeholder="Enter your Own Land" required>
