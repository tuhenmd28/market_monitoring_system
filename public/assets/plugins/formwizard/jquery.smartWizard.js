    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div></div>').addClass('btn-group mr-2 sw-btn-group-extra float-end').attr('role', 'group');
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    toolbarTop = $('<div></div>').addClass(' sw-toolbar sw-toolbar-top justify-content-' + this.options.toolbarSettings.toolbarButtonPosition);
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<div></div>').addClass(' sw-toolbar sw-toolbar-bottom justify-content-' + this.options.toolbarSettings.toolbarButtonPosition);
        ...
        _setEvents: function () {
            ...
            //custom add function to show fnish button on last step
            function showFinishOnLast(){
                if( $('.step-anchor .nav-item:last').hasClass('active') ){
                    $('.finish_button').removeClass('d-none');
                }
                else{
                    $('.finish_button').addClass('d-none');
                }
            }
            //
